...
# Histerical Squares
 ...
 Rotation of rectangles in a grid using a general pattern for simulated hysteresis. This almost entirely derivative effort is tweaking code provided by @quantixed in their post [Turn A Square: generative aRt](https://quantixed.org/2019/05/26/turn-a-square-generative-art/). The incremental change here is to organize the calculated hysteresis as rectangles instead of line segments so they can be filled with colors using the [ggplot2 library](https://ggplot2.tidyverse.org/). Using the [viridis color palette](https://cran.r-project.org/web/packages/viridis/vignettes/intro-to-viridis.html) here - seemed to work nicely.

 This function will make grid art arguments define
